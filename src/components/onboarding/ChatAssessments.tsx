  ...
  if (assessmentComplete) {
    return (
      <div className="text-center animate-fade-in">
        <h2 className="text-2xl font-semibold text-foreground mb-4">Assessment Complete!</h2>
        <p className="text-neutral-8 mb-6">Thank you for completing the assessment. We'll prepare your personalized lessons.</p>
        <button
          onClick={onComplete}
          disabled={loading}
        ...
        <div className="mb-4 min-h-[60px] p-3 border border-neutral-5 rounded-md bg-neutral-2 text-foreground">
          {userResponse || (isListening 
            ? <span className="text-accent-6 flex items-center">
                <svg className="animate-pulse w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
