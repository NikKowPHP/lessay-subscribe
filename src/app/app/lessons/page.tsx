  ...
  if (!initialized || loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-neutral-1">
        ...
        <p className="text-xl text-neutral-12">Loading your personalized lessons...</p>
        <p className="text-sm text-neutral-8 mt-2">We're preparing content based on your assessment</p>
      </div>
    )
  }
    ...
    <div className="container mx-auto py-8 px-4 bg-neutral-1 min-h-screen">
      ...
      {lessons.length === 0 ? (
        <div className="text-center py-12 border rounded-[4px] p-8 bg-neutral-2">
          <h2 className="text-2xl font-bold mb-4 text-neutral-12">Generating Your Personalized Learning Plan</h2>
          ...
          <p className="text-neutral-10">We're creating lessons tailored to your goals. Please check back in a few moments.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {lessons.map(lesson => (
            ...
            >
              <div className="p-6">
                <h2 className="text-xl font-semibold mb-2 text-neutral-12">{lesson.focusArea}</h2>
                <div className="mb-4">
                ...
                <div className="flex justify-between items-center">
                  <span className={`px-2 py-1 text-xs rounded-full ${
                    lesson.completed ? 'bg-accent-1 text-accent-9' : 'bg-accent-2 text-accent-10'
                  }`}>
