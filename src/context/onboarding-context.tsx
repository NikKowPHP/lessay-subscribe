...
import { createOnboardingAction, updateOnboardingAction, getStatusAction, getAssessmentLessonsAction, completeAssessmentLessonAction, getOnboardingAction, completeOnboardingAction } from '@/lib/server-actions/onboarding-actions'
...
export function OnboardingProvider({ children }: { children: React.ReactNode }) {
  ...
  const completeOnboardingWithLessons = async () => {
    return withLoadingAndErrorHandling(async () => {
      ...
      toast.success('Onboarding completed! Generating your personalized lessons...')
    })
  }
